...
functions:
  ...
  virtual const CTFileName &GetComputerMessageName(void) const {
    static DECLARE_CTFILENAME(fnmBullSummer, "Data\\Messages\\Enemies\\BullSummer.txt");
    static DECLARE_CTFILENAME(fnmBullWinter, "Data\\Messages\\Enemies\\BullWinter.txt");
    switch(m_bcChar) {
    default: ASSERT(FALSE);
    case BUC_SUMMER: return fnmBullSummer;
    case BUC_WINTER: return fnmBullWinter;
    }
  };
