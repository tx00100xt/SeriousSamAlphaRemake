...
#define LAVAMAN_LARGE_STRETCH (16.0f*1.5f/*2.5f*/)
...
#define WATER_LARGE_LEFT    FLOAT3D(-14.0f, 23.8f, -19.2f)
#define WATER_LARGE_RIGHT   FLOAT3D( 14.0f, 23.8f, -19.2f)
//#define WATER_LARGE_LEFT    FLOAT3D(-22.0f, 20.8f*2.7f, -29.2f)
//#define WATER_LARGE_RIGHT   FLOAT3D( 22.0f, 20.8f*2.7f, -29.2f)

#define LAVAMAN_FIRE_SMALL       (FLOAT3D(     -0.0f, 2.51133f, -0.476662f)*LAVAMAN_SMALL_STRETCH)
#define LAVAMAN_FIRE_BIG_LEFT    (FLOAT3D(-0.572948f, 2.11133f, -0.476662f)*LAVAMAN_BIG_STRETCH)
#define LAVAMAN_FIRE_BIG_CENTER  (FLOAT3D(      0.0f, 2.11133f, -0.476662f)*LAVAMAN_BIG_STRETCH)
#define LAVAMAN_FIRE_BIG_RIGHT   (FLOAT3D( 0.572948f, 2.11133f, -0.476662f)*LAVAMAN_BIG_STRETCH)

#define LAVAMAN_FIRE_LARGE_LEFT2    (FLOAT3D(-0.642948f, 2.01133f, -0.476662f)*LAVAMAN_LARGE_STRETCH)
#define LAVAMAN_FIRE_LARGE_LEFT1    (FLOAT3D(-0.372948f, 2.01133f, -0.476662f)*LAVAMAN_LARGE_STRETCH)
#define LAVAMAN_FIRE_LARGE_CENTER   (FLOAT3D(      0.0f, 2.01133f, -0.476662f)*LAVAMAN_LARGE_STRETCH)
#define LAVAMAN_FIRE_LARGE_RIGHT1   (FLOAT3D( 0.372948f, 2.01133f, -0.476662f)*LAVAMAN_LARGE_STRETCH)
#define LAVAMAN_FIRE_LARGE_RIGHT2   (FLOAT3D( 0.642948f, 2.01133f, -0.476662f)*LAVAMAN_LARGE_STRETCH)

#define ICE_ROCKS        FLOAT3D(-0.9f, 1.6f*1.4f, -1.0f)
#define ICE_ROCKS_BIG    FLOAT3D(-3.6f, 6.4f*1.4f, -4.0f)
//#define ICE_ROCKS_LARGE  FLOAT3D(-38.4f, 25.6f*2.7f, -16.0f)
#define ICE_ROCKS_LARGE  FLOAT3D(-29.0f, 25.6f*1.6f, -16.0f)
%}
...
*/
 30 model   MODEL_LAVA              "Models\\Enemies\\Elementals\\LavaMan.mdl",
 31 model   MODEL_LAVA_BODY_FLARE   "Models\\Enemies\\Elementals\\LavaManFX\\BodyFlare.mdl",
 32 model   MODEL_LAVA_HAND_FLARE   "Models\\Enemies\\Elementals\\LavaManFX\\HandFlare.mdl",
 33 texture TEXTURE_LAVA            "Models\\Enemies\\Elementals\\LavaMan01.tex",
 34 texture TEXTURE_LAVA_DETAIL     "Models\\Enemies\\Elementals\\Detail.tex",
 35 texture TEXTURE_LAVA_FLARE      "Models\\Enemies\\Elementals\\LavaManFX\\Flare.tex",
...
functions:
    ...
    case ELT_LAVA:
		{
			...
			PrecacheTexture(TEXTURE_ELEM_STONE );
			PrecacheTexture(TEXTURE_ELEM_STONE );
    ...
    FLOAT fDamageAmmount, const FLOAT3D &vHitPoint, const FLOAT3D &vDirection) 
  {
    ...
    // lava can't be burn
    if( m_EetType==ELT_LAVA && dmtType==DMT_BURNING)
    {
      return;
    }
  ...
  void StandingAnimFight(void) {
    StartModelAnim(LAVAMAN_ANIM_STAND, AOF_LOOPING|AOF_NORESTART);
  }
  ...
  void SpawnNewElemental(void) 
  {
	...
	switch (m_EetType) {
      case ELT_AIR:
        eSpawnSpray.sptType = SPT_TRAVA;
        break;
      case ELT_ICE:
        eSpawnSpray.sptType = SPT_ICE;
        break;
      case ELT_LAVA:
  ...
  // throw rocks ICE
  void ThrowRocksICE(ProjectileType EptProjectile) {
    // projectile type and position
    FLOAT3D vPos;
    ANGLE3D aAngle;
    // throw rocks
 ...
 ************************************************************/
  ...
  LavamanFire(EVoid)
  {
    ...
    m_iRndAttack = IRnd()%2;
    // shoot projectiles
    if (m_EecChar==ELC_LARGE && m_iRndAttack == 0)
    {
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK05, AOF_SMOOTHCHANGE);
      autowait(tmWait+0.8f);
      ThrowRocks(PRT_LAVAMAN_STONE_LARGE);           
      PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
      autowait( GetModelObject()->GetAnimLength( LAVAMAN_ANIM_ATTACK05) - 0.9f);
      StandingAnim();
    ...
    else if (m_EecChar==ELC_LARGE && m_iRndAttack == 1) 
    {
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK06, AOF_SMOOTHCHANGE);
      autowait(tmWait+0.8f);
      ShootProjectile(PRT_LAVAMAN_FIREBALL_LARGE, LAVAMAN_FIRE_LARGE_LEFT1, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_LARGE, LAVAMAN_FIRE_LARGE_LEFT2, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_LARGE, LAVAMAN_FIRE_LARGE_CENTER, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_LARGE, LAVAMAN_FIRE_LARGE_RIGHT2, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_LARGE, LAVAMAN_FIRE_LARGE_RIGHT1, ANGLE3D(0, 0, 0));
      PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
      autowait( GetModelObject()->GetAnimLength( LAVAMAN_ANIM_ATTACK06) - 0.9f);
      StandingAnim();
      autowait(_pTimer->TickQuantum);
      MaybeSwitchToAnotherPlayer();
      // set next shoot time
    ...
    else if (m_EecChar==ELC_BIG && m_iRndAttack == 0)
    {
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK05, AOF_SMOOTHCHANGE);
      autowait(tmWait+0.8f);
      ThrowRocks(PRT_LAVAMAN_STONE_BIG);           
      PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
      autowait( GetModelObject()->GetAnimLength( LAVAMAN_ANIM_ATTACK05) - 0.9f);
      StandingAnim();
      autowait(_pTimer->TickQuantum);
    ...
    else if (m_EecChar==ELC_BIG && m_iRndAttack == 1) 
    {
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK06, AOF_SMOOTHCHANGE);
      autowait(tmWait+0.8f);
      ShootProjectile(PRT_LAVAMAN_FIREBALL_BIG, LAVAMAN_FIRE_BIG_LEFT, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_BIG, LAVAMAN_FIRE_BIG_CENTER, ANGLE3D(0, 0, 0));
      ShootProjectile(PRT_LAVAMAN_FIREBALL_BIG, LAVAMAN_FIRE_BIG_RIGHT, ANGLE3D(0, 0, 0));
      PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
      autowait( GetModelObject()->GetAnimLength( LAVAMAN_ANIM_ATTACK06) - 0.9f);
      StandingAnim();
      autowait(_pTimer->TickQuantum);
    ...
    else if (m_EecChar==ELC_SMALL && m_iRndAttack == 0)
    {   
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK05, AOF_SMOOTHCHANGE);
    ...
    else if (m_EecChar==ELC_SMALL && m_iRndAttack == 1)
    {
      CModelObject &mo = *GetModelObject();
      FLOAT tmWait = mo.GetAnimLength( mo.ao_iCurrentAnim )-mo.GetPassedTime();  
      StartModelAnim(LAVAMAN_ANIM_ATTACK06, AOF_SMOOTHCHANGE);
      autowait(tmWait+0.8f);
      ShootProjectile(PRT_LAVAMAN_FIREBALL, LAVAMAN_FIRE_SMALL, ANGLE3D(0, 0, 0));
      PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
      autowait( GetModelObject()->GetAnimLength( LAVAMAN_ANIM_ATTACK06) - 0.9f);
      StandingAnim();
      autowait(_pTimer->TickQuantum);
  ...
  LavamanStones(EVoid)
  {
    StartModelAnim(LAVAMAN_ANIM_ATTACK04, 0);
    autowait(0.7f);
    // throw rocks
    if (m_EecChar==ELC_LARGE) {
      ThrowRocks(PRT_LAVAMAN_STONE);
  ...
  IcemanFire(EVoid) {
    ...
    // throw rocks
    if (m_EecChar==ELC_LARGE) {
      ThrowRocksICE(PRT_ICEMAN_LARGE_FIRE);
    } else if (m_EecChar==ELC_BIG) {
      ThrowRocksICE(PRT_ICEMAN_BIG_FIRE);
    } else {
      ThrowRocksICE(PRT_ICEMAN_FIRE);
    }
    PlaySound(m_soSound, SOUND_LAVA_FIRE, SOF_3D);
    autowait(0.9f);
    // stand a while
 ...
 ************************************************************/
  ...
  BossAppear(EVoid)
  {
    ...
    PlaySound(m_soSound, SOUND_LAVA_GROW, SOF_3D);
    (GetModelObject()->GetAnimLength(LAVAMAN_ANIM_MORPHPLANEUP)-_pTimer->TickQuantum);
  ...
  Main(EVoid) {
    ...
    switch (m_EetType) {
      ...
      case ELT_ICE: 
        ...
        break;
      case ELT_LAVA:
        if (m_EecChar!=ELC_SMALL) {m_fBlowUpAmount = 1E30f;}
        SetComponents(this, *GetModelObject(), MODEL_LAVA, TEXTURE_LAVA, 0, 0, 0 /* TEXTURE_LAVA_DETAIL */);
        break;
      case ELT_STONE: 
