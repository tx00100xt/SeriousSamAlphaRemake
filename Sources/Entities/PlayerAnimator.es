    ...
    if (m_bSwim) {
      ...
      switch (iWeapon) {
        ...
        case WEAPON_IRONCANNON: case WEAPON_LASER:
          iAnim += BODY_ANIM_MINIGUN_SWIMMING-BODY_ANIM_MINIGUN_STAND;
          break;
      }
    }
  ...
  void BodyAnimationTemplate(INDEX iNone, INDEX iKnife, INDEX iColt, INDEX iShotgun, INDEX iMinigun, ULONG ulFlags) {
    ...
    switch (iWeapon) {
      ...
      case WEAPON_FLAMER: case WEAPON_GHOSTBUSTER:
        ...
        break;
      case WEAPON_MINIGUN: case WEAPON_ROCKETLAUNCHER: case WEAPON_GRENADELAUNCHER:  case WEAPON_LRG: case WEAPON_LASER: 
      case WEAPON_IRONCANNON:
  ...
  void BodySwimmingAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_SWIMMING, BODY_ANIM_COLT_SWIMMING, BODY_ANIM_SHOTGUN_SWIMMING, BODY_ANIM_MINIGUN_SWIMMING, 
      ...
      // Correct Swim stand
  void BodySwimStandAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_SWIMMING, BODY_ANIM_COLT_SWIMMING, BODY_ANIM_SHOTGUN_SWIMMING, BODY_ANIM_MINIGUN_SWIMMING, 
      AOF_LOOPING|AOF_LOOPING);
  };

        // Fire Long
  void BodyFireLongAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_ATTACK, BODY_ANIM_COLT_STAND, BODY_ANIM_SHOTGUN_STAND, BODY_ANIM_MINIGUN_STAND, 
      AOF_LOOPING|AOF_LOOPING);
  };

          // Fire Short
  void BodyFireShortAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_ATTACK, BODY_ANIM_COLT_STAND, BODY_ANIM_SHOTGUN_STAND, BODY_ANIM_MINIGUN_STAND, 
      AOF_LOOPING|AOF_LOOPING);
  };

        // Correct Swim FireShort
  void BodyFSAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_SWIMMING, BODY_ANIM_COLT_SWIMMING, BODY_ANIM_SHOTGUN_SWIMMING, BODY_ANIM_MINIGUN_SWIMMING, 
      AOF_NORESTART|AOF_NORESTART);
  };

          // Correct Swim FireLong
  void BodyFLAnimation() {
    BodyAnimationTemplate(BODY_ANIM_NORMALWALK, 
     BODY_ANIM_KNIFE_SWIMMING, BODY_ANIM_COLT_SWIMMING, BODY_ANIM_SHOTGUN_SWIMMING, BODY_ANIM_MINIGUN_SWIMMING, 
      AOF_NORESTART|AOF_NORESTART);
  };
