...
functions:
  ...
  {
    CTString str;
    str.PrintF(TRANS("Fighter sent %s flying"), (const char*)strPlayerName);
    return str;
  }
  ...
  virtual const CTFileName &GetComputerMessageName(void) const {
    ...
    case RFC_KAMIKAZE: return fnmKamikaze;
    case RFC_FIGHTER: return fnmFighter;
    }
  };
