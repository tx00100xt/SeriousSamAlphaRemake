...
void DECL_DLL Particles_LavaErupting(CEntity *pen, FLOAT fStretchAll, FLOAT fSize, 
                            ...
                            FLOAT fActivateTime);
void DECL_DLL Particles_DalphaProjectileTrail_Prepare(CEntity *pen);
void DECL_DLL Particles_DalphaProjectileTrail( CEntity *pen, FLOAT fSize, FLOAT fHeight, INDEX ctParticles);
...
void DECL_DLL Particles_DalphaProjectileDebrisTrail_Prepare(CEntity *pen);
void DECL_DLL Particles_DalphaProjectileDebrisTrail(CEntity *pen, FLOAT fSizeMultiplier);
