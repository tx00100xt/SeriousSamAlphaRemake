...
functions:
  ...
  virtual const CTFileName &GetComputerMessageName(void) const {
    static DECLARE_CTFILENAME(fnmMamutSummer, "Data\\Messages\\Enemies\\MamutSummer.txt");
    static DECLARE_CTFILENAME(fnmMamutWinter, "Data\\Messages\\Enemies\\MamutWinter.txt");
    switch(m_EmcChar) {
    default: ASSERT(FALSE);
    case MAT_SUMMER: return fnmMamutSummer;
    case MAT_WINTER: return fnmMamutWinter;
    }
  };
  void Precache(void) {
    CEnemyBase::Precache();
